...
namespace IFMS
{
    public partial class Sale : Form
    {
        ...
        public void show()
        {
            try
            {
                queryClass.selectds("Select * from Sale");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                string qry = string.Format("Insert into Sale(Vehicle_Id,Product_Name,Total_Weight,Deduction,Net_Weight,Date_Time,Price)values('" + tbVehicle_Id.Text + "','" + tbProduct_Name.Text + "','" + tbtotalWeight.Text + "','" + tbDeduction.Text + "','" + tbNet_Weight.Text + "','" + dtDate_Time.Value + "','" + tbPrice.Text + "')");
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (iExit == DialogResult.Yes)
                    {
                        ...
                        string qry = string.Format("update Sale set Vehicle_Id='" + tbVehicle_Id.Text + "',Product_Name='" + tbProduct_Name.Text + "',Total_Weight='" + tbtotalWeight.Text + "',Deduction='" + tbDeduction.Text + "',Net_Weight='" + tbNet_Weight.Text + "',Date_Time='" + dtDate_Time.Value + "',Price='" + tbPrice.Text + "' where ID=@i  ");
