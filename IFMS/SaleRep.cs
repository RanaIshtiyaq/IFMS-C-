...
namespace IFMS
{
    public partial class SaleRep : Form
    {
        ...
        private DataSet3 GetDataonload()
        {
            ...
            queryClass.con.Open();
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM Sale ", queryClass.con);
        ...
        private DataSet3 GetData()
        {
            ...
            queryClass.con.Open();
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM Sale where ID LIKE '%" + tbSearch.Text + "%'", queryClass.con);
